...
voicetypes VoiceTypeTable[] = {
	...
	{ VOICE_GROUP_OPL3, 4, _T("OPL3"), _T("AL FB1 FB2"), _T("AR DR SR RR SL TL KS ML PDT WF AMVB"), 0, &CFITOMConfig::ParseOPL3Voice, &CFITOMConfig::BuildOPL3Voice, },
	{ VOICE_GROUP_MA3, 4, _T("MA3"), _T("AL FB1 FB2 HLF"), _T("AR DR SR RR SL TL KS ML DT WF AMVB"), 0, &CFITOMConfig::ParseMA3Voice, &CFITOMConfig::BuildMA3Voice, },
