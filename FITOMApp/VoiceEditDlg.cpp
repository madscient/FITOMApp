...
CVoiceEditDlg::VoiceItem CVoiceEditDlg::commonItem[] = {
	...
	{ _T("Algorithm"), 0, 0, 7, VOICE_GROUP_OPNA, &CVoiceEditDlg::SetAL, &CVoiceEditDlg::GetAL3, },
	...
	{ _T("Noise Freq"), 0, 0, 15, VOICE_GROUP_OPM, &CVoiceEditDlg::SetNFreq, &CVoiceEditDlg::GetNFreq, },
...
CVoiceEditDlg::VoiceItem CVoiceEditDlg::operatorItem[] = {
	...
	{ _T("Reverberation"), 0, 0, 7, VOICE_GROUP_OPM, &CVoiceEditDlg::SetRV, &CVoiceEditDlg::GetRV, },
	//{ _T("Reverberation"), 0, 0, 127, VOICE_GROUP_PSG, &CVoiceEditDlg::SetRV, &CVoiceEditDlg::GetRV, },
	...
	{ _T("EG-Bias"), 0, 0, 3, VOICE_GROUP_OPM, &CVoiceEditDlg::SetEGS, &CVoiceEditDlg::GetEGS, },
